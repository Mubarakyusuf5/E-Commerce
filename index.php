...
<body>
    <!-- <P>welcome <?php echo $row["uname"] ?></P>
    ...
    <div class="container">
        ...
        <div class="products">
            <div class="product">
                <img src="hh.jpg" alt="hamburger">
                <h3>Cheese Hambuger</h3>
                <p>&dollar;15</p>
                <button class="btn"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                        height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        <path fill="none" stroke="#000" stroke-width="2"
                            d="M5,5 L22,5 L20,14 L7,14 L4,2 L0,2 M7,14 L8,18 L21,18 M19,23 C18.4475,23 18,22.5525 18,22 C18,21.4475 18.4475,21 19,21 C19.5525,21 20,21.4475 20,22 C20,22.5525 19.5525,23 19,23 Z M9,23 C8.4475,23 8,22.5525 8,22 C8,21.4475 8.4475,21 9,21 C9.5525,21 10,21.4475 10,22 C10,22.5525 9.5525,23 9,23 Z">
                        </path>
                    </svg><span>Add Cart</span></button>
                <div class="status">In Stock</div>
            </div>
            <div class="product">
                <img src="hj.jpg" alt="pizza">
                <h3>Pizza</h3>
                <p>&dollar;20</p>
                <button class="btn"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                        height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
